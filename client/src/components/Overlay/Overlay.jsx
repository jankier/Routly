        ...
        <div className="container">
            ...
            <div className="header flex flex-col text-icons bg-secondary">
                <div className="flex flex-row justify-between">
                    ...
                    <div onClick={handleToggleLogin} href="/" className="flex flex-col items-center pt-5 mr-5 duration-500 hover:text-white cursor-pointer">
                ...
                <div className="text-xs pb-2 items-center m-auto">
                    <span>
